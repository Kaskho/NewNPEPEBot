...
# ==========================
@app.route(f'/trigger-wisdom-greeting/{Config.TRIGGER_SECRET}', methods=['POST'])
...
@app.route(f'/trigger-morning-greeting/{Config.TRIGGER_SECRET}', methods=['POST'])
...
@app.route(f'/trigger-noon-greeting/{Config.TRIGGER_SECRET}', methods=['POST'])
...
@app.route(f'/trigger-night-greeting/{Config.TRIGGER_SECRET}', methods=['POST'])
...
@app.route(f'/trigger-random-greeting/{Config.TRIGGER_SECRET}', methods=['POST'])
...
if __name__ == "__main__":
    if not Config.BOT_TOKEN or not Config.WEBHOOK_BASE_URL: # Check WEBHOOK_BASE_URL instead of WEBHOOK_URL
